	...
	<tbody>
		...
		<tr>
			<td class="tdContent" style="line-height:2.8;">
				<button id="goProjNew" class="button" style="width:70px;">등록</button>
				<button id="goProjDel" class="button" style="width:70px;">삭제</button>
			</td>
			<td></td>
			<td class="tdContent" style="line-height:2.8;">
				<button id="goJobNew" class="button" style="width:70px;">등록</button>
				<button id="goJobDel" class="button" style="width:70px;">삭제</button>
			</td>			
		</tr>		
	</tbody>
</table>
...
<div id="divProjProPop" title="프로젝트 속성정보" style="line-height:2.8;">
<span class="inputLabel">프로젝트ID(*)</span><input id="txtProjProProjId" type="text" class="inputText" style="width:350px;" disabled="disabled" spellcheck='false' ></input>
<br/><span class="inputLabel">프로젝트명(*)</span><input id="txtProjProProjNm" type="text" class="inputText" style="width:350px;" spellcheck='false' ></input>
<br/><span class="inputLabel">설명</span><input id="txtProjProProjDesc" type="text" class="inputText" style="width:350px;" spellcheck='false' ></input>
<br/><span class="inputLabel">수집유형</span><input id="txtProjProColectTypCd" type="text" class="inputText" style="width:350px;" spellcheck='false' ></input><span class="inputDesc">API:Open API, CRW:크롤링</span>
<br/><span class="inputLabel">출력순서</span><input id="txtProjProDispOrd" type="text" class="inputText" style="width:350px;" spellcheck='false' ></input><span class="inputDesc">정수로 입력하세요.</span>
<div id="divProjProMsg" style="display:none;"> 
<div class="ui-widget">
	<div class="ui-state-error ui-corner-all" style="padding: 0 .7em;">
		<p><span class="ui-icon ui-icon-alert" style="float: left; margin-right: .3em;"></span>
		<strong>메시지:</strong> <span id="spanProjProMsg"></span></p>
	</div>
</div>
</div>
</div>

<div id="divJobProPop" title="작업 속성정보" style="line-height:2.8;">
<span class="inputLabel">프로젝트ID(*)</span><input id="txtJobProProjId" type="text" class="inputText" style="width:350px;" disabled="disabled" spellcheck='false' ></input>
<br/><span class="inputLabel">작업ID(*)</span><input id="txtJobProJobId" type="text" class="inputText" style="width:350px;" disabled="disabled" spellcheck='false' ></input>
<br/><span class="inputLabel">작업명(*)</span><input id="txtJobProJobNm" type="text" class="inputText" style="width:350px;" spellcheck='false' ></input>
<br/><span class="inputLabel">출력순서</span><input id="txtJobProDispOrd" type="text" class="inputText" style="width:350px;" spellcheck='false' ></input><span class="inputDesc">정수로 입력하세요.</span>
<div id="divJobProMsg" style="display:none;"> 
<div class="ui-widget">
	<div class="ui-state-error ui-corner-all" style="padding: 0 .7em;">
		<p><span class="ui-icon ui-icon-alert" style="float: left; margin-right: .3em;"></span>
		<strong>메시지:</strong> <span id="spanJobProMsg"></span></p>
	</div>
</div>
</div>
</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		tabProj.jqGrid({
			datatype: "json",
			mtype:"POST",
		   	colNames:['프로젝트ID','프로젝트명', '수집유형', '설명', '출력순서', '사용자ID'],
		   	colModel:[
	...
	function fn_saveProjInfo(){
		...
		if(gfn_isNull(projNm)){
			$("#spanProjProMsg").text("프로젝트명을 입력하세요.");
