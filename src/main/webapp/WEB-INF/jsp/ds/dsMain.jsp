		...
		<tr>
			<td class="tdContent" colspan="3">			
				<div id="divProjectPro">
					<h3>Project</h3>
					<div><span class="inputLabel">Project Id</span><input id="txtProjId" type="text" class="text" style="width:100px;margin-left:10px;text-align: center;margin-top:2px;" disabled="disabled" spellcheck='false' ><input id="txtProjNm" type="text" class="text" style="width:500px;margin-left:5px;margin-top:2px;" disabled="disabled" spellcheck='false' ><button id="goProjPop" class="button" style="width:50px;margin-left:5px;margin-top:2px;">...</button><button id="goSelect" class="button" style="width:70px;margin-left:5px;margin-top:2px;">Select</button></div>
				</div>
			</td>
		</tr>
		<tr>
			<td class="tdContent" colspan="3">			
				<div id="tabsReport">
					<ul>
						...
						<li><a href="#tabs-2">Report2</a></li>
						<li><a href="#tabs-3">Report3</a></li>
					</ul>
...
<div id="divProjPop" title="Selected Project" >
